...
public class BadullaToColombo  {

    private static final int SEATING_CAPACITY = 42;
    public static final String FROM_TO = "Badulla to Colombo";
    public static String[] seatsByOder = new String[SEATING_CAPACITY];
    ...
    public static void checkTheAvailableSeats(Scanner scanner){
        int count = 0;
    ...
    public static void menu(Scanner scanner){
        String database = "badullaToColombo";
        System.out.print(
                        "\n"+ FROM_TO +" -----"+
        ...
        switch (input){
            ...
            case "o":
                ...
                break;
            case "r":
                ColomboToBadulla.selectingTheRoute(scanner);
                break;
            case "q":
                System.exit(0);
                break;
    ...
    private static void deleteCustomerFromSeat(String[] seats,Scanner scanner) {
        ...
        for (int x = 0; x < SEATING_CAPACITY; x++) {
            if (name.equals(seats[x])) {
                seats[x] = null;
                count += 1;
                System.out.println("Customer got Deleted from the seat .....");
                break;
            }
        }
        if (count == 0) {
    ...
    private static boolean display(String title,String message){
        ...
        box.getChildren().addAll(yesB,noB);
        VBox layout = new VBox(20);
        box.setAlignment(Pos.CENTER);
        layout.getChildren().addAll(label,box);
    ...
    private static void selectTheSeat(Scanner scanner){
        ...
        bookTheSeat.setFont(new Font("Arial", 23));
        ...
        Scene scene2 = new Scene(box1,400,640);
    ...
    public static void viewSeats(Scanner scanner){
        ...
        window3 = new Stage();
        window3.setMaxHeight(600);
        window3.setTitle(FROM_TO);
        window3.setMaxWidth(400);
        ...
        Scene scene3 = new Scene(box,600,600);
    ...
    public static void storeTheData(Scanner scanner,String databaseN){
        System.out.println("data is getting stored..please wait ..");
        database = new Database(date,databaseN);
        database.clear();
    ...
    public static void loadTheData(Scanner scanner, String databaseN){
